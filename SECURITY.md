...
Lesto takes security seriously. The framework ships hardening on by default — a
...
Lesto is pre-1.0. Until 1.0, security fixes land on the latest published `0.x`
...
- the affected package(s) and version(s) (e.g. `@lesto/auth@0.2.1`),
...
In scope: any `@lesto/*` package in this repository and the `create-lesto`
...
Thank you for helping keep Lesto and its users safe.
