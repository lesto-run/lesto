...
**ADR 0004 is fully realized.** `@keel/db` is the data layer; `@keel/orm` was subsequently **DELETED** in Phase 7.6 (see the note below) — there is no ORM package any more.
