...
- **Status:** Accepted — design + Increment 1 (the wire, proven on `examples/blog`). Increments 2–4 (estate convergence, scaffold flip, hardening) are sequenced below, not built here.
- **Date:** 2026-06-11
