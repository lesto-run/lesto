# Lesto — Domain Map (for the v1 launch review)
...
| 8 | Operability, API Surface & DX | `operability-dx` | observability, mcp, openapi, webhooks, cli, create-lesto, integration, e2e |
