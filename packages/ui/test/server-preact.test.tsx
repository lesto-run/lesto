 ...
 * driven through `@keel/ui`'s engine: the engine becomes the Preact dialect by
 ...
 * would force every other `@keel/ui` test onto Preact too. So this test
 * reconstructs the EXACT shell the engine emits — a `<div data-keel-island="…">`
