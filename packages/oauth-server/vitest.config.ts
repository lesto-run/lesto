...
// SKELETON (ADR 0041). Coverage thresholds are deliberately OFF here — unlike every
...
// (the ADR 0029 AS build, with ADR 0041 as its Phase 3) — at which point this config
