 ...
 * shell. This is the exact shape a real Lesto app's client entry takes.
 */

import { hydrateIslands } from "@lesto/ui/client";
import type { IslandMount } from "@lesto/ui";

import { registry } from "./registry";

const script = document.getElementById("lesto-islands");
