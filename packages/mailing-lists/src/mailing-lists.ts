...
import type { JsonValue } from "@lesto/queue";
 ...
 * the HTTP handler that fronts `subscribe` MUST apply `@lesto/ratelimit` (keyed by
 ...
 *
 * Built as a closure factory (matches `@lesto/identity`'s shape): no `this`,
