...
export function prewarmSpellChecker(checker: SpellChecker): void {
  ...
  const commonWords = [
    ...
    'here', 'should', 'need', 'has', 'more', 'very', 'been', 'was', 'were', 'being',
    'are', 'is', 'am', 'does', 'did', 'done', 'doing', 'made', 'making', 'got',
    'getting', 'going', 'went', 'said', 'saying', 'told', 'tell', 'telling', 'asked', 'ask',
    'using', 'used', 'works', 'working', 'worked', 'makes', 'gives', 'gave', 'given',
    'takes', 'took', 'taken', 'comes', 'came', 'coming', 'goes', 'gone', 'sees', 'saw',
    'seen', 'knows', 'knew', 'known', 'thinks', 'thought', 'thinking', 'wants', 'wanted', 'wanting',
    'gets', 'finds', 'found', 'finding', 'shows', 'showed', 'shown', 'showing', 'means', 'meant',
    'keeps', 'kept', 'keeping', 'lets', 'let', 'letting', 'begins', 'began', 'begun', 'beginning',
    'seems', 'seemed', 'seeming', 'leaves', 'left', 'leaving', 'calls', 'called', 'calling',
    'tries', 'tried', 'trying', 'provides', 'provided', 'providing', 'includes', 'included', 'including',
  ];
