/**
 * @keel/content-lint - Markdown Linting for Documentation
 *
 ...
 * @example
 * ```ts
 * import { lint, lintA11y, lintStructural } from "@keel/content-lint";
 *
 ...
 *
 * // Run specific checks
 * import { createLineIndex, checkAltText, checkNoEmptyUrl } from "@keel/content-lint";
