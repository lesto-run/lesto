...
function serializeEntries(entries: RuntimeEntry[], output?: OutputConfig): string {
  ...
  return `// Generated by @lesto/content-core - DO NOT EDIT
...
function generateDataTypes(collections: AnyCollection[]): string {
  const lines: string[] = [
    "// Generated by @lesto/content-core - DO NOT EDIT",
    "",
    'import type { CollectionEntry, CollectionRegistry } from "@lesto/content-core";',
    "",
  ];
