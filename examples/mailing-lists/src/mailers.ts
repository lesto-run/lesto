 ...
 *
 * `@keel/mailing-lists` never renders email itself — it hands a job to a NAMED
 * mailer template and lets `@keel/mail` render + deliver it. So the names here
 ...
 * deliverability default (and exercises @keel/mail's CRLF-normalized multipart
